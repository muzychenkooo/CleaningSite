...
export const reviewsData: PlatformReviewsGroup[] = [
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        date: '3 сент. 2024',
        rating: 5,
        text: 'Регулярно заказываем уборку в шоуруме. Важно, чтобы вещи и образцы тканей оставались в идеальном состоянии. Ребята аккуратно обращаются с товаром, всё складывают на свои места.',
      },
      {
        id: 'g5',
        authorName: 'Анна Л.',
