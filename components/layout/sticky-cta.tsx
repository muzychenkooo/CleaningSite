...
export function StickyCta() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] flex justify-center gap-3 bg-white/95 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.12)] backdrop-blur sm:hidden">
